...
Public Class FormCustomers
    Public CustomersObj As CustomersManager = New CustomersManager()
        ...
        Try
            ...
            Select Case UCase(Trim((BtnCustomers.Text)))
                ...
                Case "ADD"
                    ...
                    Call CustomersObj.AddData(name, email, address, contactNumber)
                    ...
                    TxtCustomerContactNum.Text = ""
                Case "DELETE"
                    Call CustomersObj.DeleteData(name)
                ...
                Case "UPDATE"
                    ...
                    'If Validation success,
                    Call CustomersObj.UpdateData(name, email, address, contactNumber)
            End Select
