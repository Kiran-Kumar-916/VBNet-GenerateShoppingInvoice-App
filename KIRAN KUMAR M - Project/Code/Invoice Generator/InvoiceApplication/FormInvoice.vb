...
Public Class FormInvoice
    ...
    Const InvoiceTableSubTotalCol As String = "Sub Total (After Discount)"
    ...
    Private Sub FormInvoice_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim flatAmountDiscount As FlatAmountDiscount
            ...
            Dim OrderTotalObj As New OrderTotalInvoice()
