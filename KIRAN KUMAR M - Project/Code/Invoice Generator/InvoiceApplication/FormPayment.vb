...
Public Class FormPayment
    ...
    Const PaymentTableSubTotalCol As String = "Sub Total (After Discount)"
    ...
    Private Sub FormPayment_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            ...
            'Add "Sub Total (After Discount)" column
            DataGridViewCol = New DataGridViewTextBoxColumn
            ...
            'Calculate Subtotal & Update In DataGridView 'Sub Total (After Discount)' column
            For row As Integer = 0 To DgvPurchaseSummary.RowCount - 1
                ...
                'Update 'Sub Total (After Discount)' column
    ...
    Private Sub BtnApplyFlatDiscount_Click(sender As System.Object, e As System.EventArgs) Handles BtnApplyFlatDiscount.Click
        Try
            ...
            MsgBox("You Have Earned 'Rs.500 Flat Discount' On Coupen Code.", MessageBoxButtons.OK, "Congratulations!")
            EligibleForFlatDiscount = True

        Catch ex As InvalidCoupenCodeException
            Call MsgBox(ex.Message, MessageBoxButtons.OK, "Validation Error")
        Catch ex As NotEligibleForFlatDiscountException
            Call MsgBox(ex.Message, MessageBoxButtons.OK, "Oops!")
        Catch ex As Exception
            Call MsgBox("An Unexpected Error Occurred: " & ex.Message, MessageBoxButtons.OK, "Error")
        End Try
    End Sub
